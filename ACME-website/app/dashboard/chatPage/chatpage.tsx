...
export default function ChatPage() {
  ...
  const getAutoReply = (msg: string): string => {
    ...
    if (lower.includes("invoice"))
      return "You can check the invoices or dashboard tab to see all your invoices😉";
    if (lower.includes("help")) return "You need my help with what please?🙂";
    if (lower.includes("customers"))
      return "You can check your customers tab to see all your customers😉";
    if (lower.includes("hello") || lower.includes("hi"))
      return "Hi there! How can I help today?🤔";

    const fallback = ["You can only ask about invoices and customers😊"];
